                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <!-- /.col-lg-2 (nested) -->
                                ...
                                <!-- /.col-lg-2 (nested) -->
                                <div class="col-lg-7">
                                    <?= form_open("admin/result/addresult") ?>
                                        <!-- <div class="form-group">
                                            <label>Course Name</label>
                                            <?= form_input(['name'=>'name','class' => 'form-control', 'placeholder' => 'Course name', 'value' => set_value('name')]) ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span ><a href="#" style="color: red;">Click here to view data format of Excel File.</a></span>
                                        </div>
